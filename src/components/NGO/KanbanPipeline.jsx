...
export default function KanbanPipeline() {
  ...
  return (
    <div className="w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col min-h-[500px]">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-base font-bold text-gray-900">Task Pipeline</h3>
      ...
      <div className="flex-grow overflow-x-auto pb-4 scrollbar-hide">
        <div className="flex gap-6 min-w-max h-full">
          {columns.map(col => (
            <div key={col.id} className="w-80 flex flex-col bg-gray-50/50 rounded-2xl border border-gray-100">
